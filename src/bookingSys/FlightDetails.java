...
public class FlightDetails {
	...
	private  int BASE_FARE_BIS = 2000;
	private  int BASE_FARE_ECO = 1000;
  ...
  public boolean[] getSeat() {
    ...
    private  int getBaseFareEco() {
    	return BASE_FARE_ECO;
    }
    private  int getBaseFareBis() {
...
public class Booking{
	...
	public void makeBooking(List<Integer> seats,double cost,boolean mealPref,boolean classPref,boolean status) {
		...
		updateBaseFare(classPref);
		try {
			BookingSystem.db.writeToDb(newBook,this.FlightNo);
		} catch (Exception e) {
